...
art_one = Artwork.create!(name: "The Great Tower", description: "De Chirico picture", location: "The Pushkin Museum", price: 7, user: user)
puts "Created The Great Tower"

art_two = Artwork.create!(name: "Eclipse of the Sun", description: "inter-war Weimar painting", location: "Heckscher", price: 4, user: user)
puts "Created Eclipse of the Sun"

art_three = Artwork.create!(name: "The Great Tower", description: "De Chirico picture", location: "The Pushkin Museum", price: 7, user: user)
puts "Created The Great Tower"
